...
- [x] Add canonical `configs/pipeline/dataset/stage1_*.yaml` specs for
...
| 2 | Gemeinderat | [x] | [x] | [x] | [x] | [x] | [ ] | [ ] | [ ] | [ ] | Run full conversion with `dataset=stage1_gemeinderat`. |
...
| 5 | Suno S1 | [x] | [x] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] | Run canary conversion with `dataset=stage1_suno_s1`. |
